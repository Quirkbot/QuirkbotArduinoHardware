...
#define DEVICE_INTERFACE_PROTOCOL 0x00
#endif

//	DEVICE DESCRIPTOR
const DeviceDescriptor USB_DeviceDescriptor =
	D_DEVICE(DEVICE_CLASS,DEVICE_SUB_CLASS,DEVICE_INTERFACE_PROTOCOL,64,USB_VID,USB_PID,0x100,IMANUFACTURER,IPRODUCT,ISERIALNUMBER,1);
