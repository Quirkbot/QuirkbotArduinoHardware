...
/** \file
 *  \brief Board specific LED driver header for the Quirkbot board.
 *  \copydetails Group_LEDs_QUIRKBOT
 *
...
/** \ingroup Group_LEDs
 *  \defgroup Group_LEDs_QUIRKBOT QUIRKBOT
 *  \brief Board specific LED driver header for the Quirkbot board.
 *
 *  Board specific LED driver header for the Arduino Quirkbot board (http://quirkbot.com).
 *
 *  <table>
...
#ifndef __LEDS_QUIRKBOT_H__
#define __LEDS_QUIRKBOT_H__
