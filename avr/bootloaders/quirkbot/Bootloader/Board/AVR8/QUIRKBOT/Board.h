...
/** \file
 *  \brief Board specific information header for the Quirkbot board.
 *  \copydetails Group_BoardInfo_QUIRKBOT
 *
 ...
 *  \defgroup Group_BoardInfo_QUIRKBOT QUIRKBOT
 *  \brief Board specific information header for the Quirkbot board.
 *
 *  Board specific information header for the Quirkbotboard (http://quirkbot.com).
 *
 *  @{
 */

#ifndef __BOARD_QUIRKBOT_H__
#define __BOARD_QUIRKBOT_H__
